...
latex_documents = [
    (master_doc, 'WyliodrinStudio.tex', u'Wyliodrin Studio Documentation',
     u'Diana Ghindaoanu', 'manual'),
]
...
man_pages = [
    (master_doc, 'wyliodrinstudio', u'Wyliodrin Studio Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'WyliodrinStudio', u'Wyliodrin Studio Documentation',
     author, 'WyliodrinStudio', 'One line description of project.',
     'Miscellaneous'),
]
