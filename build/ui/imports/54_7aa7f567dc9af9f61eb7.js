...
/* WEBPACK VAR INJECTION */(function(Buffer) {/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return setup; });
/* harmony import */ var dexie__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(1664);
/* harmony import */ var events__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(3);
/* harmony import */ var events__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(events__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var axios__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(219);
/* harmony import */ var axios__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(axios__WEBPACK_IMPORTED_MODULE_2__);
/* harmony import */ var jquery__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(1631);
...
let events = new events__WEBPACK_IMPORTED_MODULE_1___default.a();

var db = new dexie__WEBPACK_IMPORTED_MODULE_0__["default"]('FileSystemDataBase');
...
let web_filesystem = {
	...
	openImportDialog(options = {}) {
		...
		jquery__WEBPACK_IMPORTED_MODULE_3___default()('#importFile').trigger('click');
		jquery__WEBPACK_IMPORTED_MODULE_3___default()('body').one('focus', '*', function (e) {
			setTimeout(() => {
	...
	_registerLoadInput(filetypes = []) {
		...
		jquery__WEBPACK_IMPORTED_MODULE_3___default()('#importFile').off().remove();
		jquery__WEBPACK_IMPORTED_MODULE_3___default()('body').append('<input type="file" id="importFile" name="importFile" style="display: none;" accept="' + accept + '">');
		jquery__WEBPACK_IMPORTED_MODULE_3___default()('#importFile').on('change', e => {
			let list = [];
	...
	{
		return Buffer.from ((await axios__WEBPACK_IMPORTED_MODULE_2___default.a.request ({url: 'plugins/'+pluginName+'/data/'+filename, responseType: 'arraybuffer', method: 'get'})).data);
	},
