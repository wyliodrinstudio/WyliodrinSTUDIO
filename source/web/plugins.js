async function loadPlugins (progress = () => {}) {
	...
	progress ('dashboard.graph.extra', 3, 46);
	...
	progress ('dashboard.graph.gauge', 4, 46);
	...
	progress ('dashboard.graph.line', 5, 46);
	...
	progress ('dashboard.graph.slider', 6, 46);
	...
	progress ('dashboard.graph.speedometer', 7, 46);
	...
	progress ('dashboard.graph.switch', 8, 46);
	...
	progress ('dashboard.graph.thermometer', 9, 46);
	...
	progress ('dashboard.graph.vumeter', 10, 46);
	...
	progress ('device.simulator.rpk', 12, 46);
	...
	progress ('device.wyapp.beagleboneblack', 14, 46);
	...
	progress ('device.wyapp.picopi', 15, 46);
	...
	progress ('device.wyapp.raspberrypi', 16, 46);
	...
	progress ('device.wyapp.udooneo', 17, 46);
	...
	progress ('device.wyapp.websocket', 18, 46);
	...
	progress ('documentation.resistorcolorcodes', 20, 46);
	...
	progress ('language.nodejs', 25, 46);
	...
	progress ('language.python', 26, 46);
	...
	progress ('language.visual', 28, 46);
	...
	progress ('language.visual.gpiozero', 29, 46);
	...
	progress ('language.visual.libwyliodrin', 30, 46);
	...
	progress ('language.visual.rpk', 31, 46);
	...
	progress ('language.visual.wyapp', 32, 46);
	...
	progress ('language.visual.wyliozero', 33, 46);
	...
	progress ('projects.editor.visual', 40, 46);
