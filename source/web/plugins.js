async function loadPlugins (progress = () => {}) {
	...
	progress ('dashboard.graph.extra', 3, 43);
	...
	progress ('dashboard.graph.gauge', 4, 43);
	...
	progress ('dashboard.graph.line', 5, 43);
	...
	progress ('dashboard.graph.slider', 6, 43);
	...
	progress ('dashboard.graph.speedometer', 7, 43);
	...
	progress ('dashboard.graph.switch', 8, 43);
	...
	progress ('dashboard.graph.thermometer', 9, 43);
	...
	progress ('dashboard.graph.vumeter', 10, 43);
	...
	progress ('device.simulator.rpk', 11, 43);
	...
	progress ('device.wyapp.beagleboneblack', 13, 43);
	...
	progress ('device.wyapp.picopi', 14, 43);
	...
	progress ('device.wyapp.raspberrypi', 15, 43);
	...
	progress ('device.wyapp.udooneo', 16, 43);
	...
	progress ('device.wyapp.websocket', 17, 43);
	...
	progress ('documentation.resistorcolorcodes', 19, 43);
	...
	progress ('language.nodejs', 24, 43);
	...
	progress ('language.python', 25, 43);
	...
	progress ('language.visual', 27, 43);
	...
	progress ('language.visual.gpiozero', 28, 43);
	...
	progress ('language.visual.libwyliodrin', 29, 43);
	...
	progress ('language.visual.wyapp', 30, 43);
	...
	progress ('language.visual.wyliozero', 31, 43);
	...
	progress ('projects.editor.ace', 35, 43);
	...
	progress ('projects.editor.images', 36, 43);
	...
	progress ('projects.editor.opcuamodel', 37, 43);
	...
	progress ('projects.editor.visual', 38, 43);
