async function loadPlugins (progress = () => {}) {
	...
	progress ('dashboard.graph.extra', 3, 47);
	...
	progress ('dashboard.graph.gauge', 4, 47);
	...
	progress ('dashboard.graph.line', 5, 47);
	...
	progress ('dashboard.graph.slider', 6, 47);
	...
	progress ('dashboard.graph.speedometer', 7, 47);
	...
	progress ('dashboard.graph.switch', 8, 47);
	...
	progress ('dashboard.graph.thermometer', 9, 47);
	...
	progress ('dashboard.graph.vumeter', 10, 47);
	...
	progress ('device.simulator.rpk', 12, 47);
	...
	progress ('device.wyapp.beagleboneblack', 14, 47);
	...
	progress ('device.wyapp.picopi', 15, 47);
	...
	progress ('device.wyapp.raspberrypi', 16, 47);
	...
	progress ('device.wyapp.udooneo', 17, 47);
	...
	progress ('device.wyapp.websocket', 18, 47);
	...
	progress ('documentation.resistorcolorcodes', 20, 47);
	...
	progress ('language.nodejs', 25, 47);
	...
	progress ('language.python', 26, 47);
	...
	progress ('language.visual', 28, 47);
	...
	progress ('language.visual.gpiozero', 29, 47);
	...
	progress ('language.visual.libwyliodrin', 30, 47);
	...
	progress ('language.visual.rpk', 31, 47);
	...
	progress ('language.visual.wyapp', 32, 47);
	...
	progress ('language.visual.wyliozero', 33, 47);
	...
	progress ('projects.editor.ace', 37, 47);
	...
	progress ('projects.editor.images', 38, 47);
	...
	progress ('projects.editor.monaco', 39, 47);
	...
	progress ('projects.editor.opcuamodel', 40, 47);
	...
	progress ('projects.editor.visual', 41, 47);
