async function loadPlugins (progress = () => {}) {
	...
	progress ('dashboard.graph.extra', 3, 41);
	...
	progress ('dashboard.graph.gauge', 4, 41);
	...
	progress ('dashboard.graph.line', 5, 41);
	...
	progress ('dashboard.graph.slider', 6, 41);
	...
	progress ('dashboard.graph.speedometer', 7, 41);
	...
	progress ('dashboard.graph.switch', 8, 41);
	...
	progress ('dashboard.graph.thermometer', 9, 41);
	...
	progress ('dashboard.graph.vumeter', 10, 41);
	...
	progress ('device.wyapp.beagleboneblack', 12, 41);
	...
	progress ('device.wyapp.picopi', 13, 41);
	...
	progress ('device.wyapp.raspberrypi', 14, 41);
	...
	progress ('device.wyapp.udooneo', 15, 41);
	...
	progress ('device.wyapp.websocket', 16, 41);
	...
	progress ('documentation.resistorcolorcodes', 18, 41);
	...
	progress ('language.nodejs', 23, 41);
	...
	progress ('language.python', 24, 41);
	...
	progress ('language.visual', 26, 41);
	...
	progress ('language.visual.gpiozero', 27, 41);
	...
	progress ('language.visual.libwyliodrin', 28, 41);
	...
	progress ('language.visual.wyapp', 29, 41);
	...
	progress ('language.visual.wyliozero', 30, 41);
	...
	progress ('projects.editor.ace', 34, 41);
	...
	progress ('projects.editor.images', 35, 41);
	...
	progress ('projects.editor.visual', 36, 41);
