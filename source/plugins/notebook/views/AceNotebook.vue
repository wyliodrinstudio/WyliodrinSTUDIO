		...
		<div v-if="syntax === 'markdown'">
			<v-toolbar class="markdown-btns">
				<v-btn text @click="importImage(element)">
					<v-img src="plugins/notebook/data/img/icons/image-icon.png"></v-img>
				</v-btn>
				<v-btn text @click="addImageLink(element)">
					<v-img src="plugins/notebook/data/img/icons/imagelink-icon.png"></v-img>
				</v-btn>
				<v-btn text @click="importFile(element)">
					<v-img src="plugins/notebook/data/img/icons/file-icon.png"></v-img>
				</v-btn>
				<v-btn text @click="addLink(element)">
					<v-img src="plugins/notebook/data/img/icons/link-icon.png"></v-img>
				</v-btn>
				<v-btn text @click="numberedList(element)">
					<v-img src="plugins/notebook/data/img/icons/nlist-icon.png"></v-img>
				</v-btn>
				<v-btn text  @click="bulletedList(element)">
					<v-img src="plugins/notebook/data/img/icons/list-icon.png"></v-img>
				</v-btn>
				<v-btn text @click="boldText(element)">
					<v-img src="plugins/notebook/data/img/icons/bold-icon.png"></v-img>
				</v-btn>
				<v-btn text @click="italicText(element)">
					<v-img src="plugins/notebook/data/img/icons/italic-icon.png"></v-img>
				</v-btn>
				<v-btn text @click="heading1(element)">
					<v-img src="plugins/notebook/data/img/icons/h1-icon.png"></v-img>
				</v-btn>
				<v-btn text @click="heading2(element)">
					<v-img src="plugins/notebook/data/img/icons/h2-icon.png"></v-img>
				</v-btn>
				<v-btn text @click="heading3(element)">
					<v-img src="plugins/notebook/data/img/icons/h3-icon.png"></v-img>
				</v-btn>
				<v-btn text @click="addSource(element)">
					<v-img src="plugins/notebook/data/img/icons/source-icon.png"></v-img>
				</v-btn>
			</v-toolbar>
		</div>
