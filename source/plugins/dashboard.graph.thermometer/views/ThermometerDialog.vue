	...
	<v-card>
		...
		<v-card-text layout-padding class="signal-details">
			...
			<div class="sig-properties">
				...
				<v-text-field :label="$t('DASHBOARD_MIN_AXES_VALUE')" type="number" step=0.1 v-model="newdata.maxAxesValue"></v-text-field>
				<v-text-field :label="$t('DASHBOARD_AXIS_NAME')" v-model="newdata.axisName"></v-text-field>
			</div>
		</v-card-text>
		<v-card-actions>
