		...
		<table class="w-100">
			<tr v-for="wirelessNetwork in wirelessNetworks" :key="wirelessNetwork.s" class="w-100 task">
				<td class="w-50 signal">
					<h3><img src="img/icons/wifi-strength-100.png" aria-label="Signal strenght"> {{wirelessNetwork.s}}</h3>
				</td>
				<td class="w-50 text-right">
					<v-btn flat class="lib-app-btn">Disconnect / Change network</v-btn>
				</td>
			</tr>
		</table>
	</div>
