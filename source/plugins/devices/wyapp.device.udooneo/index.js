...
export function setup (options, imports, register)
{
	...
	imports.events.on ('ready', (imports) => 
	{
		...
		{
			studio.pin_layout.registerPinLayout ('wyapp', 'udooneo', 'plugins/devices/wyapp.device.udooneo/data/img/pins-udooneo.png');
		}
		else
		{
	...
	let udooneo = {
		...
		*/
		iconURL ()
		{
			return 'plugins/devices/wyapp.device.udooneo/data/img/icon-udooneo.png';
		},
		/**
