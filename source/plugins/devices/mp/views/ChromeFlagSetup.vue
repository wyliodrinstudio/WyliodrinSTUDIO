<template>
	<v-card>
		<v-card-title>
			<span class="headline">{{$t('DEVICE_MP_FLAG_HEADER')}}</span>
		</v-card-title>
		<v-card-text>
			<div>
				{{$t('DEVICE_MP_FLAG_STEP_ONE')}}
			</div>
			<div>
				{{$t('DEVICE_MP_FLAG_STEP_TWO')}}
			</div>
			<div>
				{{$t('DEVICE_MP_FLAG_STEP_THREE')}}
			</div>
			<div>
				{{$t('DEVICE_MP_FLAG_STEP_FOUR')}}
			</div>
			<div>
				{{$t('DEVICE_MP_FLAG_STEP_FIVE')}}
			</div>
			<div>
				{{$t('DEVICE_MP_FLAG_STEP_SIX')}}
			</div>
			<div>
		...
		<v-card-actions>
			<v-spacer></v-spacer>
			<v-btn text @click="flash" v-show="binary">{{$t('DEVICE_MP_FLASH')}}</v-btn>
