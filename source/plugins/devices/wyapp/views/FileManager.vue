			...
			<v-tooltip bottom>
				<template #activator="data">
					<v-btn text class="title-icon-btn" aria-label="Refresh" >
						<v-img contain src="plugins/devices/wyapp/data/img/icons/refresh-icon.svg"></v-img>
					</v-btn>
				</template>
...
.folder-open {
background: url('plugins/devices/wyapp/data/img/icons/32px.png') no-repeat 0px -32px !important;
	width: 32px;
	height: 32px;
}

.folder-closed {
background: url('plugins/devices/wyapp/data/img/icons/32px.png') no-repeat -64px 0px !important;
	width: 32px;
	height: 32px;
}
.file {
background: url('plugins/devices/wyapp/data/img/icons/32px.png') no-repeat -32px 0px !important;
	width: 32px;
	height: 32px;
}
</style>
