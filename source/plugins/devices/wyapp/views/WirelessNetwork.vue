			...
			<table v-else class="w-100">
				<tr v-for="wirelessNetwork in wirelessNetworks" :key="wirelessNetwork.s" class="w-100 task">
					<td class="w-50 signal">
						<h3><img :src="'plugins/devices/wyapp/data/img/icons/wifi-strength-'+signalStrength(wirelessNetwork)+'.png'" aria-label="Signal strenght"> {{networkSSID (wirelessNetwork)}}</h3>
