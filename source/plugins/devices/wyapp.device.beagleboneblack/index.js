...
export function setup (options, imports, register)
{
	...
	imports.events.on ('ready', (imports) => 
	{
		...
		{
			studio.pin_layout.registerPinLayout ('wyapp', 'beagleboneblack', 'plugins/devices/wyapp.device.beagleboneblack/data/img/pins-beagleboneblack.png');
		}
		else
		{
	...
	let beagleboneblack = {
		...
		*/
		iconURL ()
		{
			return 'plugins/devices/wyapp.device.beagleboneblack/data/img/icon-beagleboneblack.png';
		},
		/**
