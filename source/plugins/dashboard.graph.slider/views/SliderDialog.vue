	...
	<v-card>
		...
		<v-card-text layout-padding class="signal-details">
			...
			<div class="sig-properties">
				...
				<v-text-field :label="$t('DASHBOARD_MIN_VALUE')" type="number" step=0.1 v-model="newdata.minAxesValue"></v-text-field>
				<v-text-field :label="$t('DASHBOARD_MAX_VALUE')" type="number" step=0.1 v-model="newdata.maxAxesValue"></v-text-field>
				<v-text-field :label="$t('SLIDER_STEP')" type="number" step=1 v-model="newdata.step"></v-text-field>
			</div>
		</v-card-text>
		<v-card-actions>
