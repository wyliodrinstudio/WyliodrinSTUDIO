				...
				<v-tooltip left>
					<template #activator="data">
						<v-btn text class="window-button" @click="exit">
							<v-img src="plugins/workspace/data/img/icons/closeapp-icon.svg" v-on="data.on" :aria-label="$t('WORKSPACE_TOOLBAR_EXIT')" ></v-img>
						</v-btn>
					</template>
                ...
                <v-tooltip left>
					<template #activator="data">
						<v-btn text class="window-button" @click="fullscreen">
							<v-img src="plugins/workspace/data/img/icons/maximize-icon.svg" v-on="data.on" :aria-label="$t('WORKSPACE_TOOLBAR_FULLSCREEN')" ></v-img>
						</v-btn>
					</template>
				...
				<v-tooltip left>
					<template #activator="data">
						<v-btn text class="window-button" @click="minimize">
							<v-img src="plugins/workspace/data/img/icons/minimize-icon.svg" v-on="data.on" :aria-label="$t('WORKSPACE_TOOLBAR_MINIMIZE')" ></v-img>
						</v-btn>
					</template>
